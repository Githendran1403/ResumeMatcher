...
### 2. Upload Files
1. **Job Description**: Upload one JD file (required)
2. **Resumes**: Upload 1-5 resume files
...
1. **Quality**: Ensure resume files have clear, readable text
2. **Format**: PDF and DOCX work best for text extraction
3. **Content**: More detailed resumes typically get better analysis
4. **JD Length**: Longer job descriptions provide better matching context
